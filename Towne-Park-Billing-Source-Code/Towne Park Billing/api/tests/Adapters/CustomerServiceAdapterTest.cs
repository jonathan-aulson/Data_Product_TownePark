...
public class CustomerServiceAdapterTest
{
    ...
    [Fact]
    public void GetCustomersSummary_ShouldCallCustomerServiceAndReturnAdaptedResponse()
    {
        ...
        _customerService.GetCustomersSummary(userAuth).Returns(customersVo);
        ...
        var result = _customerServiceAdapter.GetCustomersSummary(userAuth);
