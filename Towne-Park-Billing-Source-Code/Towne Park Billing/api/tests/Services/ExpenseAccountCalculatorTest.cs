...
namespace BackendTests.Services
{
    public class ExpenseAccountCalculatorTest
    {
        ...
        public void CalculateAndApply_WithMultipleCallsForSameSiteYear_CachesExpenseData()
        {
            ...
            _calculator.CalculateAndApply(siteData, 2025, 5, monthValueDto, siteDetailDto1, 0m, new List<PnlRowDto>());
            _calculator.CalculateAndApply(siteData, 2025, 6, monthValueDto, siteDetailDto2, 0m, new List<PnlRowDto>());
