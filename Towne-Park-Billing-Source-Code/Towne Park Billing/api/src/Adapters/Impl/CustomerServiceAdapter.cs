...
public class CustomerServiceAdapter : ICustomerServiceAdapter
{
     ...
     */
    public IEnumerable<CustomerSummaryDto> GetCustomersSummary(UserDto userAuth)
    {
        return Mappers.CustomerSummaryMapper.CustomersVoToDto(_customerService.GetCustomersSummary(userAuth));
    }
