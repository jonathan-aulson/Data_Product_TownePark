...
namespace api.Adapters
{
    public interface IInternalRevenueMapper
    {
        ...
        ManagementAgreementVo MapManagementAgreementToVo(bs_ManagementAgreement managementAgreement);
        List<OtherRevenueVo> MapOtherRevenuesToVo(IEnumerable<bs_OtherRevenueDetail> otherRevenues); // Changed from bs_OtherRevenue to bs_OtherRevenueDetail
