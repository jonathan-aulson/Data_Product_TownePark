...
namespace api.Data
{
    public interface ISiteStatisticRepository
    {
        ...
        Task<List<SiteStatisticDetailVo>> GetBudgetData(string siteId, string billingPeriod);
        Task<List<SiteStatisticDetailVo>> GetBudgetDataForRange(string siteId, List<string> billingPeriods);
