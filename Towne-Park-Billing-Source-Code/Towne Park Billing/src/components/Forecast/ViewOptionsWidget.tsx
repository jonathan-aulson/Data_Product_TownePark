...
const ViewOptionsWidget: React.FC<ViewOptionsWidgetProps> = ({
    ...
    const comparisonOptions = ["Budget", "Previous Quarter", "Prior Year", "FP&A Projection"];
                ...
                <div className="space-y-1">
                    ...
                    <div>
                        ...
                        <Select
                            ...
                            disabled={true || isSidebarDisabled}
                            data-qa-id="select-comparison"
                        >
                            <SelectTrigger id="comparison" className="w-full mt-2" data-qa-id="trigger-comparison">
                                <SelectValue placeholder="Select a comparison" />
                            </SelectTrigger>
                            <SelectContent>
                                {comparisonOptions.map((option) => (
                                    <SelectItem key={option} value={option} disabled={option !== "Budget"} data-qa-id={`select-item-comparison-${option.replace(/\s+/g, '-').toLowerCase()}`}>
                                        {option}
                                    </SelectItem>
                                ))}
                            </SelectContent>
