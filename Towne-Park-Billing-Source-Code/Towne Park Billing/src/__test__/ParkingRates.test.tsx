...
describe('ParkingRateForm Component', () => {
    beforeEach(() => {
        ...
        // Reset the handlers - only yearChange is needed
    ...
    test('toggles between budgeted and forecasted rates', async () => {
        const mockSetSelectedSite = jest.fn();
        render(<ParkingRateForm 
            customers={mockCustomers} 
            error={null}
        ...
        const toggleButton = screen.getByTestId('parking-rates-button-toggle-budget-forecast');
        expect(toggleButton).toBeInTheDocument();
        expect(toggleButton.textContent).toContain('Show Comparison');
        
        fireEvent.click(toggleButton);
        
        // Button text should change
        expect(toggleButton.textContent).toContain('Show Forecast');
    });
