...
const mockHandlers = {
    ...
    comparisonChange: null as ((value: string) => void) | null,
};
        ...
        Select: ({ onValueChange, value, children, disabled, 'data-qa-id': qaId }: any) => {
            ...
            React.useEffect(() => {
                if (qaId === 'select-starting-year') {
                    ...
                    mockHandlers.comparisonChange = onValueChange;
                }
            }, []);
...
describe('ViewOptionsWidget Component', () => {
        ...
        render(
            <MemoryRouter>
                <ViewOptionsWidget 
                    ...
                    comparison="Budget"
                    setComparison={mockSetComparison}
    ...
    test('renders disabled comparison dropdown', () => {
        const mockSetStartingMonth = jest.fn();
        const mockSetTimePeriod = jest.fn();
        const mockSetComparison = jest.fn();
        ...
        // Check comparison selection elements
        expect(screen.getByText('Comparison')).toBeInTheDocument();
        const comparisonSelect = screen.getByTestId('select-comparison');
        expect(comparisonSelect).toBeInTheDocument();
        expect(comparisonSelect).toHaveAttribute('data-disabled', 'true');
    });
